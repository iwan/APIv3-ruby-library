...
module SibApiV3Sdk
  class EmailCampaignsApi
    ...
    def create_email_campaign_with_http_info(email_campaigns, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(email_campaigns) 
    ...
    def email_export_recipients_with_http_info(campaign_id, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'recipient_export']) 
    ...
    def get_ab_test_campaign_result_with_http_info(campaign_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'AbTestCampaignResult' 
    ...
    def get_email_campaign_with_http_info(campaign_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetEmailCampaign' 
    ...
    def get_email_campaigns_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetEmailCampaigns' 
    ...
    def get_shared_template_url_with_http_info(campaign_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSharedTemplateUrl' 
    ...
    def send_report_with_http_info(campaign_id, send_report, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(send_report) 
    ...
    def send_test_email_with_http_info(campaign_id, email_to, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(email_to) 
    ...
    def update_campaign_status_with_http_info(campaign_id, status, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(status) 
    ...
    def update_email_campaign_with_http_info(campaign_id, email_campaign, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(email_campaign) 
    ...
    def upload_image_to_gallery_with_http_info(upload_image, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(upload_image) 
