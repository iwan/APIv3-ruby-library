...
module SibApiV3Sdk
  class SendersApi
    ...
    def create_sender_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'CreateSenderModel' 
    ...
    def get_ips_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetIps' 
    ...
    def get_ips_from_sender_with_http_info(sender_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetIpsFromSender' 
    ...
    def get_senders_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSendersList' 
