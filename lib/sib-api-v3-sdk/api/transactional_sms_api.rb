...
module SibApiV3Sdk
  class TransactionalSMSApi
    ...
    def get_sms_events_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSmsEventReport' 
    ...
    def get_transac_aggregated_sms_report_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetTransacAggregatedSmsReport' 
    ...
    def get_transac_sms_report_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetTransacSmsReport' 
    ...
    def send_transac_sms_with_http_info(send_transac_sms, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(send_transac_sms) 

      # return_type
      return_type = opts[:return_type] || 'SendSms' 
