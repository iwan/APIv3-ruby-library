...
module SibApiV3Sdk
  class SMSCampaignsApi
    ...
    def create_sms_campaign_with_http_info(create_sms_campaign, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_sms_campaign) 
    ...
    def get_sms_campaign_with_http_info(campaign_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSmsCampaign' 
    ...
    def get_sms_campaigns_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSmsCampaigns' 
    ...
    def send_test_sms_with_http_info(campaign_id, phone_number, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(phone_number) 
    ...
    def update_sms_campaign_with_http_info(campaign_id, update_sms_campaign, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_sms_campaign) 
