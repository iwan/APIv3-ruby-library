...
module SibApiV3Sdk
  class ContactsApi
    ...
    def add_contact_to_list_with_http_info(list_id, contact_emails, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(contact_emails) 

      # return_type
      return_type = opts[:return_type] || 'PostContactInfo' 
    ...
    def create_attribute_with_http_info(attribute_category, attribute_name, create_attribute, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_attribute) 
    ...
    def create_contact_with_http_info(create_contact, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_contact) 

      # return_type
      return_type = opts[:return_type] || 'CreateUpdateContactModel' 
    ...
    def create_doi_contact_with_http_info(create_doi_contact, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_doi_contact) 
    ...
    def create_folder_with_http_info(create_folder, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_folder) 
    ...
    def create_list_with_http_info(create_list, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_list) 
    ...
    def get_attributes_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetAttributes' 
    ...
    def get_contact_info_with_http_info(identifier, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetExtendedContactDetails' 
    ...
    def get_contact_stats_with_http_info(identifier, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetContactCampaignStats' 
    ...
    def get_contacts_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetContacts' 
    ...
    def get_folder_with_http_info(folder_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetFolder' 
    ...
    def get_folder_lists_with_http_info(folder_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetFolderLists' 
    ...
    def get_folders_with_http_info(limit, offset, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetFolders' 
    ...
    def get_list_with_http_info(list_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetExtendedList' 
    ...
    def get_lists_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetLists' 
    ...
    def import_contacts_with_http_info(request_contact_import, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(request_contact_import) 

      # return_type
      return_type = opts[:return_type] || 'CreatedProcessId' 
    ...
    def request_contact_export_with_http_info(request_contact_export, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(request_contact_export) 
    ...
    def update_attribute_with_http_info(attribute_category, attribute_name, update_attribute, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_attribute) 
    ...
    def update_contact_with_http_info(identifier, update_contact, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_contact) 
    ...
    def update_folder_with_http_info(folder_id, update_folder, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_folder) 
    ...
    def update_list_with_http_info(list_id, update_list, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_list) 
