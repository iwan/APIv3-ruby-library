...
module SibApiV3Sdk
  class TransactionalEmailsApi
    ...
    def create_smtp_template_with_http_info(smtp_template, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(smtp_template) 
    ...
    def delete_hardbounces_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'delete_hardbounces']) 
    ...
    def get_aggregated_smtp_report_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetAggregatedReport' 
    ...
    def get_email_event_report_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetEmailEventReport' 
    ...
    def get_smtp_report_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetReports' 
    ...
    def get_smtp_template_with_http_info(template_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSmtpTemplateOverview' 
    ...
    def get_smtp_templates_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSmtpTemplates' 
    ...
    def get_transac_blocked_contacts_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetTransacBlockedContacts' 
    ...
    def get_transac_email_content_with_http_info(uuid, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetTransacEmailContent' 
    ...
    def get_transac_emails_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetTransacEmailsList' 
    ...
    def send_template_with_http_info(template_id, send_email, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(send_email) 

      # return_type
      return_type = opts[:return_type] || 'SendTemplateEmail' 
    ...
    def send_test_template_with_http_info(template_id, send_test_email, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(send_test_email) 
    ...
    def send_transac_email_with_http_info(send_smtp_email, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(send_smtp_email) 

      # return_type
      return_type = opts[:return_type] || 'CreateSmtpEmail' 
