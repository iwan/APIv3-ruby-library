...
module SibApiV3Sdk
  class ResellerApi
    ...
    def add_credits_with_http_info(child_identifier, add_credits, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(add_credits) 

      # return_type
      return_type = opts[:return_type] || 'RemainingCreditModel' 
    ...
    def associate_ip_to_child_with_http_info(child_identifier, ip, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(ip) 
    ...
    def create_child_domain_with_http_info(child_identifier, add_child_domain, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(add_child_domain) 
    ...
    def create_reseller_child_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'reseller_child']) 

      # return_type
      return_type = opts[:return_type] || 'CreateReseller' 
    ...
    def get_child_account_creation_status_with_http_info(child_identifier, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetChildAccountCreationStatus' 
    ...
    def get_child_domains_with_http_info(child_identifier, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'Array<GetChildDomain>' 
    ...
    def get_child_info_with_http_info(child_identifier, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetChildInfo' 
    ...
    def get_reseller_childs_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetChildrenList' 
    ...
    def get_sso_token_with_http_info(child_identifier, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'GetSsoToken' 
    ...
    def remove_credits_with_http_info(child_identifier, remove_credits, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(remove_credits) 
    ...
    def update_child_account_status_with_http_info(child_identifier, update_child_account_status, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_child_account_status) 
    ...
    def update_child_domain_with_http_info(child_identifier, domain_name, update_child_domain, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_child_domain) 
    ...
    def update_reseller_child_with_http_info(child_identifier, reseller_child, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(reseller_child) 
